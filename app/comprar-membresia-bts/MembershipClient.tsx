...
const PRICING: Record<string, { symbol: string, price: string, link: string }> = {
    PE: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' },
    MX: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' },
    CO: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' },
    CL: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' },
    BR: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' },
    AR: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' },
    DEFAULT: { symbol: '$', price: '33.73 USD', link: 'https://www.paypal.com/ncp/payment/8XABRYNE7AXY4' }
};
