...
export default function Terminos() {
    return (
        <div className="max-w-4xl mx-auto py-10 pt-24 px-4 bg-black text-white">
            <h1 className="text-4xl md:text-5xl font-black uppercase italic mb-8 text-white">
                Terminos y <span className="gradient-text">Condiciones</span>
            </h1>

            <GlassCard className="prose prose-invert max-w-none prose-headings:font-bold prose-headings:uppercase prose-p:text-white/70 prose-strong:text-white">
                <p className="font-mono text-sm text-white/50 mb-6">Vigencia: A partir del 01 de Enero de 2025</p>

                <div className="bg-primary/10 border border-primary/30 p-4 rounded-xl mb-8">
