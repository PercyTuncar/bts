...
export default function BTSDubaiNewsPage() {
  const jsonLd = {
    ...
    "dateModified": "2026-02-02T20:10:00+00:00",
    "author": [{
      "@type": "Person",
      "name": "Percy Tunccar",
    ...
    "description": "Los 7 miembros de BTS han sido vistos viajando a Dubai. Confirmamos los detalles de su llegada y analizamos las posibilidades de un nuevo tour mundial."
  };
      ...
      <div className="max-w-none text-lg text-slate-800 leading-relaxed font-sans">
        ...
        <div className="relative w-full aspect-video bg-black rounded-xl overflow-hidden my-10 shadow-sm border border-slate-900">
           <video 
             ...
             poster="/images/video-poster-placeholder.jpg" // Optional: You might want to add a poster image later
           >
             <source src="/images/video-bts-en-el-aeropuerto.mp4" type="video/mp4" />
