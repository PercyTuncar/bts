...
export const Logo = ({ className = "" }: { className?: string }) => {
    return (
        <div className={`flex items-center gap-3 ${className}`}>
            ...
            {/* Custom SVG Ticket Shape */}
            <div className="relative w-10 h-6 transform -rotate-12 hover:rotate-0 transition-transform duration-300 drop-shadow-sm group">
                <svg
                    viewBox="0 0 100 60"
                    fill="none"
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <img
                        ...
                        alt="BTS Logo"
                        className="w-2.5 h-2.5 object-contain invert brightness-0 opacity-100"
                    />
                </div>
            </div>
